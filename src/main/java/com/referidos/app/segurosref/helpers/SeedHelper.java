...
public class SeedHelper {
    ...
    public Object[] updateBrands(BrandRepository brandRepository, boolean refreshData) {
        ...
        this.buildBrandsPart3(brands);
        this.buildBrandsPart4(brands);
        if (refreshData) {
        ...
        if (brandsDB.isEmpty()) {
            ...
            return new Object[] { "Se han creado las marcas", brands };
        }
        // Existe data en la DB, así que hay que comparar
        for (BrandModel brand : brands) {
            ...
            for (BrandModel brandDB : brandsDB) {
                ...
                if (brandName.equals(brandNameDB)) {
                    // Existe la marca y ahora se revisa si están los ids de las aseguradoras que
                    // hacen referencia a la marca
                    isBrand = true;
                    for (BrandInsurerModel insurerBrandId : brand.getInsurersId()) {
                        String insurerNameForBrandId = insurerBrandId.getName();
                    ...
                    // Ya revisamos si están los ids de las aseguradoras que hacen referencia a la
                    // marca, ahora buscamos que
                    // Se encuentren todos los modelos de la marca
                    for (BrandDataModel model : brand.getModels()) {
                        ...
                        if (!isModel) {
                            brandDB.addModel(model);
                        }
                    }
                    break; // Break para salir de la búsqueda de la marca porque se encontró
                }
            }
            if (!isBrand) {
                brandsDB.add(brand);
    ...
    private List<BrandModel> buildBrandsPart1(List<BrandModel> brands) {
        brands.add(new BrandModel("ALFA ROMEO", new ArrayList<>(), new ArrayList<>())
                .addInsurerBrandId(new BrandInsurerModel(1, "BCI"))
                .addModel(new BrandDataModel(new ObjectId(), "BRERA", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(10, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "ALFA 159", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(9, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "MITO", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1537, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GIULIA", "SEDAN", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "TONALE HIBRIDO", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(10474, "BCI"))));
        brands.add(new BrandModel("AUDI", new ArrayList<>(), new ArrayList<>())
                .addInsurerBrandId(new BrandInsurerModel(2, "BCI"))
                .addModel(new BrandDataModel(new ObjectId(), "A1", "HATCHBACK", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "Q7", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(20, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "S1", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2750, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "SQ5", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2239, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "S3", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1569, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "S4", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(21, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "S5", "COUPE", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1539, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "S5 CABRIO", "COUPE", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2238, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "S6", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(16, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "Q2", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1871, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "Q3", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1766, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "Q5", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1067, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "A3 SEDAN", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2208, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "A5 SPORTBACK", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(9273, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "Q5 SPORTBACK", "SUV", new ArrayList<>())
        ...
        brands.add(new BrandModel("BAIC", new ArrayList<>(), new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "PLUS", "FURGON", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2497, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "BJ40 PLUS", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(9992, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "X55 PLUS", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(10138, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "X25", "CROSSOVER", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2731, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "X35", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2835, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "X55", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2816, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "UP", "HATCHBACK", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "BJ40", "SUV", new ArrayList<>())
        ...
        brands.add(new BrandModel("BMW", new ArrayList<>(), new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "114I", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1969, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "116", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1580, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "118", "HATCHBACK", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "318", "SEDAN", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "523", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(43, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "525", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(30, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "528", "SEDAN", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "X2 M35I", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(3138, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "X3", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(51, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "X3 M40I 30", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(3023, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "X3 XDRIVE 30", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(3021, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "X3 XDRIVE 35", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(3022, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "X4", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2470, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "X4 M40I 30", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(3025, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "X4 XDRIVE 35", "SUV", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "X1 XDRIVE 28", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(3020, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "X3 M50 30", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(10458, "BCI"))));
        brands.add(new BrandModel("BRILLIANCE", new ArrayList<>(), new ArrayList<>())
                .addInsurerBrandId(new BrandInsurerModel(226, "BCI"))
                .addModel(new BrandDataModel(new ObjectId(), "H220", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2231, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "H230", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2195, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "H2L", "MINIBUS", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2836, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "FRV", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1673, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "FSV", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1674, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "SPLENDOR", "SEDAN", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "KONECT", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(3511, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "V3", "CROSSOVER", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2725, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "V5", "STATION WAGON", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2064, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "EUPHORIA", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2158, "BCI"))));
        brands.add(new BrandModel("BYD", new ArrayList<>(), new ArrayList<>())
                .addInsurerBrandId(new BrandInsurerModel(51, "BCI"))
                .addModel(new BrandDataModel(new ObjectId(), "G3", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1667, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "S1", "CROSSOVER", new ArrayList<>())
        ...
        brands.add(new BrandModel("CHANGAN", new ArrayList<>(), new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "A500", "STATION WAGON", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "S200", "CAMIONETA", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(831, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "CHANGAN CM5", "FURGON", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "X7 PLUS", "SUV", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "ALSVIN", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(9021, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "HUNTER", "CAMIONETA", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(3628, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "CS35 PLUS", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(3538, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "CM10", "FURGON", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2021, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "CS1", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1960, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "CS15", "CROSSOVER", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2767, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "CS35", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2094, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "EADO", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2099, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "CS55", "STATION WAGON", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(3088, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "CS75", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2752, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "CV1", "CITYCAR", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1970, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "CV2", "SEDAN", new ArrayList<>())
        ...
        brands.add(new BrandModel("CHERY", new ArrayList<>(), new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "ARRIZO 3", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2707, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "ARRIZO 5", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2715, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "ARRIZO 7", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2699, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "BEAT", "STATION WAGON", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1518, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GRAND TIGGO", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2487, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "IQ", "CITYCAR", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "TIGGO", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(731, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "TIGGO 2", "CROSSOVER", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2803, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "TIGGO 3 PRO", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(9829, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "TIGGO 3", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2804, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "TIGGO 7 PRO", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(9129, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "TIGGO 2 PRO", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(9282, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "TIGGO 8 PRO", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(9470, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "TIGGO 8", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(3559, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "K60", "STATION WAGON", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(3543, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "TIGGO 4", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(654, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "TIGGO 7", "SUV", new ArrayList<>())
        ...
        brands.add(new BrandModel("CHEVROLET", new ArrayList<>(), new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "BLAZER", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(77, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "MONTANA", "CAMIONETA", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(98, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "S-10", "CAMIONETA", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(67, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "SONIC", "SEDAN", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "N300 MAX", "FURGON", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "N 400 MAX", "FURGON", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(3571, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GROOVE", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(8989, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "ONIX RS", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(9003, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "TRACKER", "CROSSOVER", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(107, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "TRAIL BLAZER", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(88, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "TRAVERSE", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1072, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "UPLANDER", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(100, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "COBALT", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2775, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "COLORADO", "CAMIONETA", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(103, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "CHEV COMBO", "FURGON", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(81, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "CORSA", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(105, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "CRUZE", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1073, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "CRUZE 5", "SEDAN", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "CAPTIVA", "SUV", new ArrayList<>())
        ...
        brands.add(new BrandModel("CITROEN", new ArrayList<>(), new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "DS5", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2102, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "C-1", "CITYCAR", new ArrayList<>())
        ...
        brands.add(new BrandModel("CUPRA", new ArrayList<>(), new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "FORMENTOR", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(9797, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "ATECA", "SUV", new ArrayList<>())
        ...
        brands.add(new BrandModel("DFM", new ArrayList<>(), new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "AX5", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2943, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "AX7", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2744, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "A30", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2771, "BCI")))
                ...
                .addModel(new BrandDataModel(new ObjectId(), "SX5", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(698, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "SX6", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(699, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "S30", "SEDAN", new ArrayList<>())
        ...
        brands.add(new BrandModel("DFSK", new ArrayList<>(), new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "C32", "CAMIONETA", new ArrayList<>())
        ...
        brands.add(new BrandModel("DODGE", new ArrayList<>(), new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "NITRO", "TODO TERRENO", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(736, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "DAKOTA", "CAMIONETA", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(187, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "DART", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2046, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "DURANGO", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(189, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "CALIBER", "HATCHBACK", new ArrayList<>())
        ...
        brands.add(new BrandModel("DONGFENG", new ArrayList<>(), new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "AX5", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2942, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "AX7", "SUV", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "SX6", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(702, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "S30", "SEDAN", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "E-TRAVEL", "MINIBUS", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2165, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "DF 2500", "CAMIONETA", new ArrayList<>())
        ...
        brands.add(new BrandModel("DS", new ArrayList<>(), new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "DS7 CROSSBACK", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2921, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "DS3 HIBRIDO", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(30236, "BCI"))));
        brands.add(new BrandModel("EXEED", new ArrayList<>(), new ArrayList<>())
                .addInsurerBrandId(new BrandInsurerModel(718, "BCI"))
                .addModel(new BrandDataModel(new ObjectId(), "LX", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(9812, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "TXL", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(9813, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "VX", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(9814, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "RX", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(10470, "BCI"))));
        brands.add(new BrandModel("FAW", new ArrayList<>(), new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "OLEY", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2268, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "X80", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2472, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "V2", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1991, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "V5", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2191, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "D60", "STATION WAGON", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2897, "BCI"))));
        return brands;
    }

    private List<BrandModel> buildBrandsPart2(List<BrandModel> brands) {
        brands.add(new BrandModel("FIAT", new ArrayList<>(), new ArrayList<>())
                .addInsurerBrandId(new BrandInsurerModel(10, "BCI"))
                .addModel(new BrandDataModel(new ObjectId(), "ARGO", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2910, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "BRAVO", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(200, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "FIAT 500", "CITYCAR", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1545, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "500 ABARTH", "CITYCAR", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "FULLBACK", "CAMIONETA", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2730, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "QUBO", "STATION WAGON", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2089, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "STRADA", "CAMIONETA", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(204, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "SIENA", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(205, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "PANDA", "CITYCAR", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "TIPO", "SEDAN", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "FIORINO", "FURGON", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(193, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "DOBLO", "FURGON", new ArrayList<>())
        ...
        brands.add(new BrandModel("FORD", new ArrayList<>(), new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "ESCAPE HIBRIDO", "SUV", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "EDGE", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(836, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "ESCAPE", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(232, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "EXPLORER", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(213, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "FIESTA", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(219, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "FOCUS", "SEDAN", new ArrayList<>())
        ...
        brands.add(new BrandModel("FOTON", new ArrayList<>(), new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "FT 500", "CAMIONETA", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2795, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "FT-BOX", "FURGON", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "G7", "CAMIONETA", new ArrayList<>())
        ...
        brands.add(new BrandModel("GAC GONOW", new ArrayList<>(), new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "GS4", "STATION WAGON", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2981, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GS5", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2179, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GA5", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2180, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "EMKOO", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(10156, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "EMZOOM", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(10194, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "EMPOW", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(10280, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GS8", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(10104, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GS3 POWER", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(9825, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GS4 POWER", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(9826, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GS3", "STATION WAGON", new ArrayList<>())
        ...
        brands.add(new BrandModel("GEELY", new ArrayList<>(), new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "GS", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2965, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GEELY MK", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1103, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GEELY LC", "CITYCAR", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1546, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "LC CROSS", "CITYCAR", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(3002, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GC7", "SEDAN", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "AZKARRA", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(9466, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "X7", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2967, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GEELY CK", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1102, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GEELY EC7", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1548, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "EMGRAND 7", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2966, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "EX7", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2145, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "STARRAY", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(10440, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "OKAVANGO", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(10441, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "COOLRAY LITE", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(30126, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "CITYRAY", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(30133, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "EX2 ELECTRICO", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(30223, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "EX5 ELECTRICO", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(30114, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GX3 PRO", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(10305, "BCI"))));
        brands.add(new BrandModel("GREAT WALL", new ArrayList<>(), new ArrayList<>())
                .addInsurerBrandId(new BrandInsurerModel(38, "BCI"))
                .addModel(new BrandDataModel(new ObjectId(), "6", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2805, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "H3", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2236, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "H5", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2495, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "H6", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2494, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "HAVAL 3", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1997, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "M4", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2194, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "HAVAL 5", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1998, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "TANK 300", "SUV", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "VOLEEX C50", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2144, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "WINGLE", "CAMIONETA", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(837, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "WINGLE 5", "CAMIONETA", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2704, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "WINGLE 6", "CAMIONETA", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2705, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "FLORID", "HATCHBACK", new ArrayList<>())
        ...
        brands.add(new BrandModel("HAFEI", new ArrayList<>(), new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "RUIYI", "CAMIONETA", new ArrayList<>())
        ...
        brands.add(new BrandModel("HAIMA", new ArrayList<>(), new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "HAIMA2", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1671, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "HAIMA7", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1992, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "HAIMA3", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1512, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "F-STAR", "FURGON", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2045, "BCI"))));
        brands.add(new BrandModel("HAVAL", new ArrayList<>(), new ArrayList<>())
                .addInsurerBrandId(new BrandInsurerModel(253, "BCI"))
                .addModel(new BrandDataModel(new ObjectId(), "H2", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2633, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "H6", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2632, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "H7", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2881, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "H6 HIBRIDO", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(9791, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "DARGO", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(9799, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "H6 GT COUPE", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(10076, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "JOLION HIBRIDO", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(10097, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "JOLION", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(9125, "BCI"))));
        brands.add(new BrandModel("HIGER", new ArrayList<>(), new ArrayList<>())
                .addInsurerBrandId(new BrandInsurerModel(251, "BCI"))
                .addModel(new BrandDataModel(new ObjectId(), "PARADISE", "MINIBUS", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2610, "BCI"))));
        brands.add(new BrandModel("HONDA", new ArrayList<>(), new ArrayList<>())
                .addInsurerBrandId(new BrandInsurerModel(12, "BCI"))
                .addModel(new BrandDataModel(new ObjectId(), "ACCORD", "SEDAN", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "WR-V", "CROSSOVER", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2821, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "CIVIC SI", "COUPE", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1448, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "CR-V", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(240, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "FIT", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(245, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "CITY", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1779, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "CIVIC", "SEDAN", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "CR-V HIBRIDO", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(30131, "BCI"))));
        brands.add(new BrandModel("HYUNDAI", new ArrayList<>(), new ArrayList<>())
                .addInsurerBrandId(new BrandInsurerModel(13, "BCI"))
                .addModel(new BrandDataModel(new ObjectId(), "ATOS", "CITYCAR", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(258, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "ACCENT", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(254, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "ACCENT", "SEDAN", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "I-10", "CITYCAR", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "I-30 N", "HATCHBACK", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "SANTA FE", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(262, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "PORTER", "CAMIONETA", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "VERNA", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(267, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "HD 35", "CAMIONETA", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1023, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "VENUE", "CROSSOVER", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(3547, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "XG", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(260, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "TUCSON", "SUV", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "CRETA", "SUV", new ArrayList<>())
        ...
        brands.add(new BrandModel("INFINITI", new ArrayList<>(), new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "M37", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2032, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "FX37", "SUV", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "G37 SEDAN", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2029, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "Q50 3.0", "SEDAN", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "Q70", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2215, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "QX30", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1021, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "QX50", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2214, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "QX60", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2582, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "QX70", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2213, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "QX80", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2700, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "Q50", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2218, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "EX37", "SUV", new ArrayList<>())
        ...
        brands.add(new BrandModel("JAC", new ArrayList<>(), new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "JAC J5 B15", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1553, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "B CLASS", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(3013, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "JAC137", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1555, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "JAC137", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1967, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GRAND S3", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(663, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "JAC J2", "CITYCAR", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1737, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "J4", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2586, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "J5", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1972, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "J6", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1984, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "REFINE", "FURGON", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1286, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "REIN", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(878, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "S1", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(664, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "S2", "STATION WAGON", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2729, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "SUNRAY", "MINIBUS", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1762, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "T6", "CAMIONETA", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2724, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "S3", "SUV", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "JS2", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(9015, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "JS3", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(9016, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "JS4", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(9060, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "T8 PRO", "CAMIONETA", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(9429, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "JS8", "SUV", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "T8", "CAMIONETA", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(3532, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "S4", "SUV", new ArrayList<>())
        ...
        brands.add(new BrandModel("JAECOO", new ArrayList<>(), new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "JAECOO 8", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(30102, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "JAECOO 7", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(10307, "BCI"))));
        brands.add(new BrandModel("JAGUAR", new ArrayList<>(), new ArrayList<>())
                .addInsurerBrandId(new BrandInsurerModel(35, "BCI"))
                .addModel(new BrandDataModel(new ObjectId(), "F-PACE 2.0", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2721, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "XF S", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(9425, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "XF SE", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(9426, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "XE PRESTIGE", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(711, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "XE SE", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(3542, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "XE PURE", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2626, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "XE R", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2627, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "XE S", "SEDAN", new ArrayList<>())
        ...
        brands.add(new BrandModel("JETOUR", new ArrayList<>(), new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "DASHING", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(10128, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "X90 PLUS", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(10207, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "X70", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(10063, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "X70 PLUS", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(10064, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "X50", "SUV", new ArrayList<>())
        ...
        brands.add(new BrandModel("JIM", new ArrayList<>(), new ArrayList<>())
                .addInsurerBrandId(new BrandInsurerModel(733, "BCI"))
                .addModel(new BrandDataModel(new ObjectId(), "RE-MAX", "CAMIONETA", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(10340, "BCI"))));
        brands.add(new BrandModel("JINBEI", new ArrayList<>(), new ArrayList<>())
                .addInsurerBrandId(new BrandInsurerModel(223, "BCI"))
                .addModel(new BrandDataModel(new ObjectId(), "HAISE", "FURGON", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2036, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "MINIBUS", "MINIBUS", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1514, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "FURGON", "FURGON", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1513, "BCI"))));
        return brands;
    }

    private List<BrandModel> buildBrandsPart3(List<BrandModel> brands) {
        brands.add(new BrandModel("JMC", new ArrayList<>(), new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "VIGUS", "CAMIONETA", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(3089, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "CARRYING", "CAMIONETA", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1950, "BCI"))));
        brands.add(new BrandModel("KAIYI", new ArrayList<>(), new ArrayList<>())
                .addInsurerBrandId(new BrandInsurerModel(722, "BCI"))
                .addModel(new BrandDataModel(new ObjectId(), "KYX 3", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(10439, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "KYX 7", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(30107, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "KYE 5", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(10424, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "KYX 3 PRO", "SUV", new ArrayList<>())
        ...
        brands.add(new BrandModel("KIA MOTORS", new ArrayList<>(), new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "SORENTO", "SUV", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "STINGER", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(508, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "RIO", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(300, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "RIO 3", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1720, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "RIO 4", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1710, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "RIO 5", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(318, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "NIRO", "STATION WAGON", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "EV9 ELECTRICO", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(10173, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "SONET", "CROSSOVER", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(9031, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "SELTOS", "CROSSOVER", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(3577, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "SOLUTO", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(3500, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "CADENZA", "SEDAN", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "CERATO5", "HATCHBACK", new ArrayList<>())
        ...
        brands.add(new BrandModel("LEXUS", new ArrayList<>(), new ArrayList<>())
                .addInsurerBrandId(new BrandInsurerModel(39, "BCI"))
                .addModel(new BrandDataModel(new ObjectId(), "GS 200 T", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(3037, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GS 250", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(843, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GS 300 AWD", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(718, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GS 350", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1989, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GS 350 F", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2297, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GS 450 H F", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2298, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GS 450 H", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2303, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "IS 200 T", "SEDAN", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "IS 300", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(661, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "IS 300 H", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2540, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "IS 350", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2001, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "IS 350 F", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2302, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "LS 460", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2002, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "LS 500 H", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2959, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "LX 570", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2003, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "RX 350", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(918, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "RX 350 F", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2299, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "RX 450 H", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2098, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "RX 450H F", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2300, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "NX 300 F", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(3039, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "NX 200T", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2590, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "NX 200T F", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2591, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "NX 300", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(3038, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "NX 300H", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2592, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "NX 300H F", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2593, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "NX 250", "SUV", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "ES 350", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2232, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "CT 200 H", "HATCHBACK", new ArrayList<>())
        ...
        brands.add(new BrandModel("LIFAN", new ArrayList<>(), new ArrayList<>())
                .addInsurerBrandId(new BrandInsurerModel(53, "BCI"))
                .addModel(new BrandDataModel(new ObjectId(), "LIFAN 320", "CITYCAR", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1304, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "LIFAN 520", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1105, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "LIFAN 620", "SEDAN", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "LIFAN X60", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1706, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "X7", "STATION WAGON", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2898, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "X70", "SUV", new ArrayList<>())
        ...
        brands.add(new BrandModel("LYNK Y CO", new ArrayList<>(), new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "08 HIBRIDO", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(30163, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "06", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(10422, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "09 HIBRIDO", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(10423, "BCI"))));
        brands.add(new BrandModel("MAHINDRA", new ArrayList<>(), new ArrayList<>())
                .addInsurerBrandId(new BrandInsurerModel(50, "BCI"))
                .addModel(new BrandDataModel(new ObjectId(), "KUV 100", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(3085, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GENIO", "CAMIONETA", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "XUV 3XO", "CROSSOVER", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(30200, "BCI"))));
        brands.add(new BrandModel("MAXUS", new ArrayList<>(), new ArrayList<>())
        ...
        brands.add(new BrandModel("MAZDA", new ArrayList<>(), new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "BT-50", "CAMIONETA", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(345, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "MAZDA3", "HATCHBACK", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "CX60", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(10100, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "CX60 HIBRIDO", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(10101, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "CX-30", "CROSSOVER", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(3566, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "CX-3", "CROSSOVER", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2643, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "CX-5", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1747, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "CX-7", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(347, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "CX-9", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(346, "BCI"))));
        brands.add(new BrandModel("MERCEDES BENZ", new ArrayList<>(), new ArrayList<>())
                .addInsurerBrandId(new BrandInsurerModel(19, "BCI"))
                .addModel(new BrandDataModel(new ObjectId(), "B 180", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1359, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "B 200", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(782, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "B 220", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(518, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "C 180", "SEDAN", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "A 170", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(791, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "A 180", "HATCHBACK", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "ML 250", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1763, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "ML 300", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1350, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "ML 350", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(714, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "ML 400", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2560, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "ML 500", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1081, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "C 220", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(786, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GL 350", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1608, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GL 450", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1346, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GL 500", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1128, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GLA 200", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2202, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GLA 220", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2203, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GLA 250", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2204, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GLC 220D", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2688, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GLC 220D COUPE", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(246, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GLC 250", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2689, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GLC 250D", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2690, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GLC 250D COUPE", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(348, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GLC 300", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2868, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GLC 300 COUPE", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2869, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GLC 350D", "SUV", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "GLE 350D", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(3053, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GLE 400", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2673, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GLE 400 COUPE", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2676, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GLK 220", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1347, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GLK 280", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2241, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GLK 300", "SUV", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "GLB 200", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(3603, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GLB 200D", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(3604, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GLB 250", "SUV", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "GLC 200 COUPE", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(3640, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GLC 200D", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(3641, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GLC 200D COUPE", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(3642, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GLC 300D", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(3643, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GLC 300D COUPE", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(3644, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GLE 400D COUPE", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(3645, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "E 450", "SEDAN", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "VITO", "MINIBUS", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(806, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "X 250D", "CAMIONETA", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2945, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "X 350D", "CAMIONETA", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(3126, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "CL 500", "COUPE", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1330, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "CLA 180", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2583, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "CLA 220 CDI", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2051, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "CLA 250 CGI", "SEDAN", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "E 200 COUPE", "COUPE", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "E 500", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(778, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "E 200", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(807, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "C 250", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1511, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "C 250 COUPE", "COUPE", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "C 350", "SEDAN", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "C 43 AMG", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2759, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "C 450", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2686, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "C 450 AMG", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2687, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "C 63 AMG", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(775, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "CITAN", "FURGON", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2160, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "CLA 45S AMG", "SEDAN", new ArrayList<>())
        ...
        brands.add(new BrandModel("MG", new ArrayList<>(), new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "MG 3", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1754, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "MG 6", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1770, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "MG 750", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1549, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "MG 350", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1544, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GS", "SEDAN", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "MG 5", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2090, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "MG 550", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1612, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "RX5", "SUV", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "ZS", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2915, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "ZS EV", "SUV", new ArrayList<>())
        ...
        brands.add(new BrandModel("MITSUBISHI", new ArrayList<>(), new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "ASX", "CROSSOVER", new ArrayList<>())
        ...
        brands.add(new BrandModel("NISSAN", new ArrayList<>(), new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "SENTRA", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(399, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "ALTIMA", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(393, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "MARCH", "CITYCAR", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1668, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "JUKE", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1738, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "KICKS", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2770, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "LEAF", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2977, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "QASHQAI", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1083, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "TEANA", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1084, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "TERRANO", "CAMIONETA", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(401, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "MURANO", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(412, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "NAVARA", "CAMIONETA", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(418, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "X-TRAIL", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(411, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "NOTE", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2101, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "NP300", "CAMIONETA", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2654, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "NV350", "MINIBUS", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "TIIDA", "SEDAN", new ArrayList<>())
    ...
    private List<BrandModel> buildBrandsPart4(List<BrandModel> brands) {
        brands.add(new BrandModel("OMODA", new ArrayList<>(), new ArrayList<>())
                .addInsurerBrandId(new BrandInsurerModel(726, "BCI"))
                .addModel(new BrandDataModel(new ObjectId(), "C5", "SUV", new ArrayList<>())
        ...
        brands.add(new BrandModel("OPEL", new ArrayList<>(), new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "ADAM", "CITYCAR", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2510, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GRANDLAND X", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(703, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "INSIGNIA", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1750, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "INSIGNIA OPC", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1986, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "MERIVA", "HATCHBACK", new ArrayList<>())
        ...
        brands.add(new BrandModel("PEUGEOT", new ArrayList<>(), new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "BIPPER", "FURGON", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "308 GTI", "HATCHBACK", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "208 GT", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(10081, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "3008 GT", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(9032, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "LANDTREK", "CAMIONETA", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(9446, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "5008 GT", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2889, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "TRAVELLER", "MINIBUS", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2833, "BCI")))
        ...
        brands.add(new BrandModel("RAM", new ArrayList<>(), new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "RAM 1200", "CAMIONETA", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "1500 TRX", "CAMIONETA", new ArrayList<>())
        ...
        brands.add(new BrandModel("RENAULT", new ArrayList<>(), new ArrayList<>())
                .addInsurerBrandId(new BrandInsurerModel(24, "BCI"))
                .addModel(new BrandDataModel(new ObjectId(), "ALASKAN", "CAMIONETA", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2855, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "MASTER", "FURGON", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "LAGUNA", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(466, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "LATITUDE", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1558, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "LOGAN", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(471, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "STEPWAY", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1640, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "SANDERO", "HATCHBACK", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "ARKANA", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(8990, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "CLIO", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(454, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "CLIO RS", "HATCHBACK", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "DUSTER", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1748, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "CAPTUR", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2501, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "ARKANA HIBRIDO", "SUV", new ArrayList<>())
        ...
        brands.add(new BrandModel("SEAT", new ArrayList<>(), new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "TARRACO", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(8998, "BCI"))));
        brands.add(new BrandModel("SHINERAY", new ArrayList<>(), new ArrayList<>())
        ...
        brands.add(new BrandModel("SSANGYONG", new ArrayList<>(), new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "KYRON", "SUV", new ArrayList<>())
        ...
        brands.add(new BrandModel("SUBARU", new ArrayList<>(), new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "BRZ", "COUPE", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1772, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "IMPREZA WRX", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1094, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "IMPREZA", "SEDAN", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "WRX", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1375, "BCI"))));
        brands.add(new BrandModel("SUZUKI", new ArrayList<>(), new ArrayList<>())
                .addInsurerBrandId(new BrandInsurerModel(31, "BCI"))
                .addModel(new BrandDataModel(new ObjectId(), "ALTO", "CITYCAR", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(550, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "APV", "FURGON", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "KIZASHI", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1525, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "IGNIS", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(559, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "SWIFT", "HATCHBACK", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "CELERIO", "CITYCAR", new ArrayList<>())
        ...
        brands.add(new BrandModel("SWM", new ArrayList<>(), new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "G05", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(10169, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "G03F", "STATION WAGON", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(10206, "BCI"))));
        brands.add(new BrandModel("TATA", new ArrayList<>(), new ArrayList<>())
                .addInsurerBrandId(new BrandInsurerModel(59, "BCI"))
                .addModel(new BrandDataModel(new ObjectId(), "XENON", "CAMIONETA", new ArrayList<>())
        ...
        brands.add(new BrandModel("TOYOTA", new ArrayList<>(), new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "AYGO", "CITYCAR", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2958, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "RAV-4", "SUV", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "RAV-4 HYBRID", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(3084, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "RUSH", "STATION WAGON", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2749, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "YARIS", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(587, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "PRIUS", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(922, "BCI")))
                ...
                .addModel(new BrandDataModel(new ObjectId(), "RAIZE", "HATCHBACK", new ArrayList<>())
        ...
        brands.add(new BrandModel("VOLKSWAGEN", new ArrayList<>(), new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "AMAROK", "CAMIONETA", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1302, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "ATLAS", "SUV", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "JETTA", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(605, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "KOMBI", "FURGON", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(606, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GOL", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(604, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GOLF", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(603, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "GOLF GTI", "HATCHBACK", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "SCIROCCO", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2460, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "MULTIVAN", "FURGON", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "PASSAT CC", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(322, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "POLO", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(612, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "POLO GTI", "HATCHBACK", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1137, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "NIVUS", "CROSSOVER", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(9014, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "VIRTUS GTS", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(9056, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "POLO GTS", "HATCHBACK", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "TRANSPORTER", "FURGON", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(856, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "VENTO", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(611, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "VIRTUS", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2926, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "VOYAGE", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2110, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "CRAFTER", "FURGON", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(2151, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "CROSSFOX", "HATCHBACK", new ArrayList<>())
        ...
        brands.add(new BrandModel("VOLVO", new ArrayList<>(), new ArrayList<>())
                .addInsurerBrandId(new BrandInsurerModel(34, "BCI"))
                .addModel(new BrandDataModel(new ObjectId(), "S-40", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(628, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "S-40 T5", "SEDAN", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "S-80 T6", "SEDAN", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1650, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "S-90", "SEDAN", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "XC-60", "SUV", new ArrayList<>())
                        .addInsurerModelId(new BrandInsurerModel(1092, "BCI")))
                .addModel(new BrandDataModel(new ObjectId(), "XC-60 D5", "SUV", new ArrayList<>())
                ...
                .addModel(new BrandDataModel(new ObjectId(), "XC-90 D5", "SUV", new ArrayList<>())
