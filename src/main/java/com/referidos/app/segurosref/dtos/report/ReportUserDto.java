...
@Data
@JsonPropertyOrder(value = {"userId", "name", "email", "commission", "generalMessage", "account", "transactionData"})
public class ReportUserDto {
    ...
    public ReportUserDto(String userId, String name, String email, int commission, String generalMessage, CommissionAccountDto account) {
